...
[task_local]
#京喜领88元红包
10 * * * * https://jdsharedresourcescdn.azureedge.net/jdresource/jd_jxlhb.js, tag=京喜领88元红包, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
==============Loon==============
[Script]
cron "10 * * * *" script-path=https://jdsharedresourcescdn.azureedge.net/jdresource/jd_jxlhb.js,tag=京喜领88元红包
================Surge===============
京喜领88元红包 = type=cron,cronexp="10 * * * *",wake-system=1,timeout=3600,script-path=https://jdsharedresourcescdn.azureedge.net/jdresource/jd_jxlhb.js
===============小火箭==========
京喜领88元红包 = type=cron,script-path=https://jdsharedresourcescdn.azureedge.net/jdresource/jd_jxlhb.js, cronexpr="10 * * * *", timeout=3600, enable=true
 */
/**
*
    Name: 京喜牧场刷金币
...
[task_local]
10 * * * * https://gitee.com/lxk0301/jd_scripts/raw/master/jd_zoo.js, tag=国潮
    BoxJS订阅
